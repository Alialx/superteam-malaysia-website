...
export default function HomePage() {
  ...
  >
    {/* Content */}
    <div className="relative z-10 flex flex-col lg:flex-row items-start justify-between max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pt-[clamp(6rem,18vw,22.5rem)] pb-10 lg:pb-16 ">

      <HeroSection/>
    </div>
    <AnimatedTagline text="Built by Malaysians, Recognized Globally." className="text-2xl"/>
